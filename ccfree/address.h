 ...
 */
#ifndef __CCFREE_ADDRESS_H__
#define __CCFREE_ADDRESS_H__
...
public:
     ...
     * @param[in] host 域名,服务器名等.举例: www.ccfree.top[:80] (方括号为可选内容)
...
public:
     ...
     * @param[in] address 域名,IP,服务器名等.举例: www.ccfree.top
     * @param[in] port 端口号
