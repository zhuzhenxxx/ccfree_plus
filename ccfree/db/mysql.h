#ifndef __CCFREE_DB_MYSQL_H__
#define __CCFREE_DB_MYSQL_H__
...
public:
    ...
    ccfree::IStmt::ptr prepare(const std::string& sql) override;
...
class MySQLManager {
public:
    typedef ccfree::Mutex MutexType;
...
typedef ccfree::Singleton<MySQLManager> MySQLMgr;
