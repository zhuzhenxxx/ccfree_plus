#ifndef __CCFREE_ROCK_ROCK_STREAM_H__
#define __CCFREE_ROCK_ROCK_STREAM_H__

#include "ccfree/streams/async_socket_stream.h"
#include "rock_protocol.h"
#include "ccfree/streams/load_balance.h"
...
class RockStream : public ccfree::AsyncSocketStream {
public:
    typedef std::shared_ptr<RockStream> ptr;
    typedef std::function<bool(ccfree::RockRequest::ptr
                               ,ccfree::RockResponse::ptr
                               ,ccfree::RockStream::ptr)> request_handler;
    typedef std::function<bool(ccfree::RockNotify::ptr
                               ,ccfree::RockStream::ptr)> notify_handler;
...
protected:
    ...
    void handleRequest(ccfree::RockRequest::ptr req);
    void handleNotify(ccfree::RockNotify::ptr nty);
private:
...
public:
    ...
    RockConnection();
    bool connect(ccfree::Address::ptr addr);
};
