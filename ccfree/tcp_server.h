 ...
 */
#ifndef __CCFREE_TCP_SERVER_H__
#define __CCFREE_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(ccfree::IOManager* worker = ccfree::IOManager::GetThis()
              ,ccfree::IOManager* io_woker = ccfree::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(ccfree::Address::ptr addr, bool ssl = false);
