#ifndef __CCFREE_MODULE_H__
#define __CCFREE_MODULE_H__

#include "ccfree/stream.h"
...
public:
    ...
    virtual bool onConnect(ccfree::Stream::ptr stream);
    virtual bool onDisconnect(ccfree::Stream::ptr stream);
    
    virtual bool onServerReady();
    virtual bool onServerUp();

    virtual bool handleRequest(ccfree::Message::ptr req
                               ,ccfree::Message::ptr rsp
                               ,ccfree::Stream::ptr stream);
    virtual bool handleNotify(ccfree::Message::ptr notify
                              ,ccfree::Stream::ptr stream);
...
public:
    ...
    virtual bool handleRockRequest(ccfree::RockRequest::ptr request
                        ...
                        ,ccfree::RockStream::ptr stream) = 0;
...
typedef ccfree::Singleton<ModuleManager> ModuleMgr;
