 ...
 */
#ifndef __CCFREE_SOCKET_H__
#define __CCFREE_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(ccfree::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(ccfree::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(ccfree::Address::ptr address);
