...
int32_t FunctionWSServlet::onConnect(ccfree::http::HttpRequest::ptr header
...
int32_t FunctionWSServlet::onClose(ccfree::http::HttpRequest::ptr header
                                     ,ccfree::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(ccfree::http::HttpRequest::ptr header
