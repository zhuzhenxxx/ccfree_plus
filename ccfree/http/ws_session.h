#ifndef __CCFREE_HTTP_WS_SESSION_H__
#define __CCFREE_HTTP_WS_SESSION_H__

#include "ccfree/config.h"
#include "ccfree/http/http_session.h"
#include <stdint.h>
...
extern ccfree::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
