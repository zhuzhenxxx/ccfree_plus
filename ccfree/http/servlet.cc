...
int32_t FunctionServlet::handle(ccfree::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("ccfree/1.0"));
}

int32_t ServletDispatch::handle(ccfree::http::HttpRequest::ptr request
               , ccfree::http::HttpResponse::ptr response
               , ccfree::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(ccfree::http::HttpRequest::ptr request
                   , ccfree::http::HttpResponse::ptr response
                   , ccfree::http::HttpSession::ptr session) {
    response->setStatus(ccfree::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "ccfree/1.0.0");
