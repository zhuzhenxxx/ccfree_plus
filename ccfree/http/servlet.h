 ...
 */
#ifndef __CCFREE_HTTP_SERVLET_H__
#define __CCFREE_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(ccfree::http::HttpRequest::ptr request
                   ...
                   , ccfree::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (ccfree::http::HttpRequest::ptr request
                   , ccfree::http::HttpResponse::ptr response
                   , ccfree::http::HttpSession::ptr session)> callback;
