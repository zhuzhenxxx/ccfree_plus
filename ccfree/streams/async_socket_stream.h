#ifndef __CCFREE_STREAMS_ASYNC_SOCKET_STREAM_H__
#define __CCFREE_STREAMS_ASYNC_SOCKET_STREAM_H__
...
public:
    void setWorker(ccfree::IOManager* v) { m_worker = v;}
    ccfree::IOManager* getWorker() const { return m_worker;}

    void setIOManager(ccfree::IOManager* v) { m_iomanager = v;}
    ccfree::IOManager* getIOManager() const { return m_iomanager;}
...
protected:
    ...
    bool waitFiber();
protected:
    ccfree::FiberSemaphore m_sem;
    ccfree::FiberSemaphore m_waitSem;
    ...
    ccfree::IOManager* m_iomanager;
    ccfree::IOManager* m_worker;
