#ifndef __CCFREE_ORM_TABLE_H__
#define __CCFREE_ORM_TABLE_H__
...
private:
    ...
    std::string m_dbclass = "ccfree::IDB";
    std::string m_queryclass = "ccfree::IDB";
    std::string m_updateclass = "ccfree::IDB";
