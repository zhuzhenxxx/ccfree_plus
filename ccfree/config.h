 ...
 */
#ifndef __CCFREE_CONFIG_H__
#define __CCFREE_CONFIG_H__
...
public:
    ...
    std::string toString() override {
        try {
            ...
            CCFREE_LOG_ERROR(CCFREE_LOG_ROOT()) << "ConfigVar::toString exception "
    ...
    bool fromString(const std::string& val) override {
        try {
            ...
            CCFREE_LOG_ERROR(CCFREE_LOG_ROOT()) << "ConfigVar::fromString exception "
...
public:
    ...
    static typename ConfigVar<T>::ptr Lookup(const std::string& name,
        ...
        if(it != GetDatas().end()) {
            ...
            if(tmp) {
                CCFREE_LOG_INFO(CCFREE_LOG_ROOT()) << "Lookup name=" << name << " exists";
                return tmp;
            } else {
                CCFREE_LOG_ERROR(CCFREE_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
        ...
        if(name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678")
                != std::string::npos) {
            CCFREE_LOG_ERROR(CCFREE_LOG_ROOT()) << "Lookup name invalid " << name;
