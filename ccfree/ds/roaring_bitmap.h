#ifndef __CCFREE_DS_ROARING_BITMAP_H__
#define __CCFREE_DS_ROARING_BITMAP_H__
...
public:
    ...
    void writeTo(ccfree::ByteArray::ptr ba) const;
    bool readFrom(ccfree::ByteArray::ptr ba);
