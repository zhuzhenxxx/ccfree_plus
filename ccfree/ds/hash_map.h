#ifndef __CCFREE_DS_HASH_MAP2_H__
#define __CCFREE_DS_HASH_MAP2_H__
...
public:
    ...
    void swap(HashMap& oth) {
        ccfree::RWMutex::WriteLock lock(m_mutex);
        ccfree::RWMutex::WriteLock lock2(oth.m_mutex);
...
template<class K
        ...
        ,class PosHash
        >
ccfree::RWMutex HashMap<K, V, PosHash>::s_mutex[MAX_MUTEX];
